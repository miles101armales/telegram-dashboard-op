...
Продукты с наибольшей прибылью:
	...
	1.	Миллион на дропах - Доступ к чату (продление на 240 дней) — 5,389,452 ₽
	2.	Годовая программа “Деньги под ключ” (старт 19 августа) (в рассрочку) — 3,154,330.5 ₽
	3.	Миллион на дропах с поддержкой (старт 16 сентября) (в рассрочку) — 2,422,112 ₽

Дни с наибольшей прибылью:

	1.	22 августа — 1,728,156 ₽
	2.	29 августа — 1,581,611 ₽
	3.	20 августа — 1,477,268 ₽
          `,
          {
            parse_mode: 'HTML',
            reply_markup: {
